...
//route pour récuperer un modifiedPattern précisen fonction'id OK
...
router.post('/', async (req, res) => {
    try {
        ...
        if (!resultMove) {
            try {
                const resultCloudinary = await cloudinary.uploader.upload(photoPath, {folder: 'modifiedPatterns'});
